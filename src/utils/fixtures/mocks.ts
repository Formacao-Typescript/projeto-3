...
export const dummyDatabase = <ReturnEntity extends (...args: any) => Serializable>(
  ...
  return {
    findById: vi.fn((id: string) => methodReturns['findById'] ?? entityFactory({ id })),
    list: vi.fn(() => methodReturns['list'] ?? [entityFactory()]),
    listBy: vi.fn(
    ...
    save: vi.fn((_entity: ReturnType<ReturnEntity>) => methodReturns['save'] ?? this),
